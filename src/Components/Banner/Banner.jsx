...
export default function Banner() {
  return (
    <div className=" h-full md:h-[600px]">
      <div className="max-w-screen-xl mx-auto  mt-10 z-0 ">
        <Swiper
          autoplay={{
            delay: 3000,
                ...
                <div className="flex gap-10 pyu-2 md:py-5 md:items-center flex-col md:flex-row">
                  ...
                  <div className="flex gap-32 items-center py-2 md:py-0">
                    <div className="flex relative items-center">
                      ...
                      <Image
                        src={coffe2}
                        className="absolute left-12 border-2 rounded-full w-14  "
                      />
                      <Image
                        src={coffe3}
                        className="absolute left-24 border-2 rounded-full w-14 "
                      />
                    </div>
                ...
                <div className="flex gap-10 pyu-2 md:py-5 md:items-center flex-col md:flex-row">
                  ...
                  <div className="flex gap-32 items-center py-2 md:py-0">
                    <div className="flex relative items-center">
                      <Image
                        src={coffe1}
                        className="border-2 rounded-full w-14 z-0"
                      />
                      <Image
                        src={coffe2}
